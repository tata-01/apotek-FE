...
<body>
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="conten">
        <div class="ml-sm-2 px-md-5">
          <br />
          <br />
          <strong>
            <p>Edit Supplier</p>
          </strong>
          <form id="update_supplier" class="alert alert-secondary">
            ...
            <div class="form-group text-dark">
              <label for="no_handphone" class="control-label">No Handphone</label>
  ...
  <script src="../assets/js/supplier_edit.js"></script>
</body>
