...
<body>
    ...
    <div class="row">
      ...
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
        ...
        <section class="text-center">
          <div class="">
            <label for="kodeInput">Enter Kode:</label>
            <input type="text" id="kodeInput" name="kodeInput" />
            <!-- Button to trigger GET request -->
            <button onclick="getOneData()">Get Data</button>
          </div>
          <div class="text-center" style="margin-top:-75px ;">
            <div class="text-dark p-5   ">

              <div class="text-dark p-5" style="width:auto;">
                <table class="table table  table-bordered text-dark   table-hover " style="margin-left: 5px;">
  ...
  <script src="../assets/js/supplier_data.js"></script>
</body>
