...
<body>
    <nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
        <a class="navbar-brand col-md-3 col-lg-2 mr-0 px-3" href="#">Apotek Asahi</a>
    ...
    <div class="container-fluid">
        <div class="row">
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="sidebar-sticky pt-3" style="height: 100vh">
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link active" href="../dasboard/dasboard.html" style="color: black">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="obat_input.html" style="color: black">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-in-down" viewBox="0 0 16 16">
                                    <path fill-rule="evenodd" d="M3.5 6a.5.5 0 0 0-.5.5v8a.5.5 0 0 0 .5.5h9a.5.5 0 0 0 .5-.5v-8a.5.5 0 0 0-.5-.5h-2a.5.5 0 0 1 0-1h2A1.5 1.5 0 0 1 14 6.5v8a1.5 1.5 0 0 1-1.5 1.5h-9A1.5 1.5 0 0 1 2 14.5v-8A1.5 1.5 0 0 1 3.5 5h2a.5.5 0 0 1 0 1z" />
                                    <path fill-rule="evenodd" d="M7.646 11.854a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 10.293V1.5a.5.5 0 0 0-1 0v8.793L5.354 8.146a.5.5 0 1 0-.708.708l3 3z" />
                                </svg>
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
                <div class="conten" style="width: 850px;">
                    <div class="text-dark " style="margin-left: 150px;">
                        <strong>
                            <br>
                            <p>Input Obat</p>
                        </strong>
                        <div class="rounded-pill alert alert-secondary" style="margin-top:10px; ">
                            <div class="form-group">
                                <form id="obatTable" action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select class="custom-select" id="kode_supplier" name="kode_supplier" required>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <select class="custom-select" id="kode_kategori" name="kode_kategori" required>
                                                <option value="">Select</option>
                                                <option value="1">1</option>
                                                <option value="2">2</option>
                                                <option value="3">3</option>
                                    ...
                                    <button type="submit" class="btn btn-primary" style="margin-left: 580px ;" data-toggle="modal" data-target="#modalSaya">
                                        Simpan
                                    </button>
                                </form>
                            </div>
    ...
    <script src="../assets/js/obat_input.js"></script>
</body>
